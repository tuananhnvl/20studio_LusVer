...
function Model({ children, color = 'white', roughness = 0, ...props }) {
    ...
    return (
        <mesh ref={ref} castShadow receiveShadow scale={.04} geometry={nodes.AMesh2_numbers_0002.geometry} position={[0.05, 0, -0.05]}>
